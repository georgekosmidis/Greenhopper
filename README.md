...
## Ideation
The idea of using [Carbon Aware SDK](https://github.com/Green-Software-Foundation/carbon-aware-sdk) was born in [Azure Developer Community Conference 2022](https://azuredev.org/). The first introduction was in the same conference during the "[Sustainability: Carbon Aware Azure Functions
